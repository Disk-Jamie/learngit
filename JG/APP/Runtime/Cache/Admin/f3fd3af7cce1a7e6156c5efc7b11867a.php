                    ...
                    <div class="panel panel-default">
                        ...
                        <div data-example-id="form-validation-states">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form" action="<?php echo U('Admin/User/insert');?>" method="post" enctype="multipart/form-data">
                                            
                                            <div class="form-group has-error">
                                                <label for="inputSuccess1" class="control-label">*邮箱账号</label>
                                                <input type="text" name="email" placeholder="请输入可用邮箱账号" class="form-control">
                                            </div>

                                            <div class="form-group has-error">
                                                <label for="inputSuccess1" class="control-label">*密码</label>
                                                <input type="password" name="pwd" placeholder="请输入6~18位数字,字母,下划线" class="form-control">
                                            </div>

                                            <div class="form-group has-error">
                                                <label for="inputSuccess1" class="control-label">*用户名</label>
                                                <input name="username" placeholder="请输入6~18位数字,字母,下划线" type="text" aria-describedby="helpBlock2" id="inputSuccess1" class="form-control">
                                            </div>

                                            <div class="form-group has-success">
                                                <label for="inputSuccess1" class="control-label">公司</label>
                                                <input name="cpy" placeholder="请输入您所在的公司" type="text" aria-describedby="helpBlock2" id="inputSuccess1" class="form-control">
                                            </div>

                                            <div class="form-group has-success">
                                                <label for="inputSuccess1" class="control-label">职位</label>
                                                <input name="pot" placeholder="请输入您的职位" type="text" aria-describedby="helpBlock2" id="inputSuccess1" class="form-control">
                                            </div>
